...
## Product Overview
**One-liner:** Árkos hace que los procesos de una empresa funcionen mejor con automatización e IA, y le enseña a su equipo a usarla. La formación, la consultoría y el desarrollo a medida (ERPs, CRMs, PMS, SaaS, webs y apps) son los medios; los precios están publicados.
**What it does:** Trabaja en tres pasos: taller de adopción de tecnología para el equipo, diagnóstico de procesos y desarrollo a medida. Diseña y desarrolla sistemas desde la operación real del cliente (entrevistas, mapa de proceso, prototipo en Figma, sprints quincenales con demos) y los entrega con código fuente, capacitación y acompañamiento. La entrada es el taller; el diagnóstico es honesto y puede concluir "todavía no necesitas un sistema". Tiene dos productos propios que prueban la capacidad SUNAT y de pagos, que es una pieza más y no la identidad: FacturArkos (facturación electrónica SUNAT + POS para Mypes) y RestHUB (ERP de restaurante). No es una fábrica de software: el onboarding de cada cliente lo hace Rodrigo de punta a punta, con poblaciones de 5 a más de 200 usuarios, y desde 2024 acompaña a empresas de salud, banca, transporte, logística, comercio y sector naval a incorporar IA: asistentes con bases de conocimiento propias conectados a sus CRM y ERP, automatizaciones, formación por perfil, gobierno legible y medición. Equipo de nueve personas desde 2022.
**Product category:** Empresa de tecnología en Lima, Perú: mejora de procesos, automatización y adopción de tecnología e IA en empresas (habilitación de usuarios de negocio), con desarrollo de software a medida. Estantes por los que buscan: "mejora de procesos en empresas", "automatización de procesos", "capacitación en IA para equipos", "desarrollo de software a medida Perú", "empresa de software Lima", "ERP para restaurantes", "sistema de facturación electrónica", "CRM para servicio técnico", "PMS hotelero", "desarrollo web Lima", "adopción de IA en empresas", "capacitación en IA para equipos", "asistente RAG para empresa", "automatización con n8n".
...
**Business model:** Proyectos por alcance con precios "desde" publicados en S/ y USD (único del mercado limeño auditado que los publica). Orden de la oferta (2026-09-22): 1) Taller de adopción de tecnología, con la IA como camino — puerta de entrada, S/ 1,900 por grupo, 4 h, hasta 20 personas, lo dicta Rodrigo, enseña criterio de uso y deja un mapa de tareas repetidas (`/taller`); 2) Diagnóstico de procesos: llamada gratis (30 min) y Diagnóstico profundo de S/ 950 (2 semanas, análisis de procesos + informe + roadmap con costos) que se descuenta íntegro del proyecto, con garantía de devolución si no encuentra pérdidas de al menos 3x su precio al año (S/ 2,850, método de `/costo-del-excel`); 3) desarrollo a medida. El taller NO se descuenta del diagnóstico. Los programas de adopción más largos se cotizan por alcance (personas, perfiles, sistemas a conectar); la integración técnica parte de S/ 1,900. Objetivo operativo: convertir proyectos en retainers de soporte/evolución post-entrega. No ofrece pauta publicitaria (Meta/Google Ads).
...
**Primary use case:** Que los procesos funcionen mejor: ordenarlos, automatizar lo que se hace a mano y que el equipo aprenda a usar la tecnología y la IA con criterio. Cuando hace falta, reemplazar una operación armada con Excel, WhatsApp, cuadernos y sistemas sueltos que no se hablan por un sistema a medida que unifique venta, operación, caja y cumplimiento.
**Jobs to be done:**
...
## Differentiation
**Key differentiators:**
- Recorrido por pasos: taller (S/ 1,900 por grupo) → diagnóstico de procesos (S/ 950) → desarrollo a medida. Cada paso deja algo que sirve aunque no se contrate el siguiente.
- Precios publicados en S/ y USD, con factores y modelos de pago. Nadie más en Lima lo hace.
- Diagnóstico honesto que puede concluir "todavía no": filtro de asesor, no de vendedor. El profundo (S/ 950) se descuenta íntegro del proyecto y se devuelve si no encuentra pérdidas de al menos 3x su precio al año (S/ 2,850).
- SUNAT (facturación electrónica CPE con OSE/PSE, PLE/SIRE, validación RENIEC/SUNAT, Ley 29733) ya no es diferenciador de identidad (2026-09-23): es una capacidad de los sistemas a medida, útil como prueba (FacturArkos, RestHUB).
...
**Words to use:** procesos, mejora de procesos, automatización, adopción de tecnología, criterio de uso, taller, diagnóstico de procesos, operación, sistema, cuadra / no cuadra, cierre de caja, software a medida, facturación electrónica (como capacidad), honesto, criterio, "todavía no", pyme / Mype, soles, desde la operación real, código fuente tuyo, en producción, adopción, uso sostenido, línea base, formación en el puesto, habilitación, "reportamos solo lo que podemos verificar".
**Words to avoid:** "Bytecore" (nombre viejo; nunca, ni como "antes Bytecore"); "fábrica de software" / "software factory" como descripción propia (Árkos se define en contra de eso); "transformación digital", "soluciones innovadoras", "equipo multidisciplinario", "experiencias digitales que conectan marcas" (copy genérico heredado, ya retirado del About el 2026-09-10: no reintroducir); "IA" como promesa vaga sin medición; vender el stack como argumento ("No vendo Next.js"); "Trujillo" como sede (Árkos opera desde Lima); métricas o clientes inventados; "Desarrollador Full Stack" como título; prometer SUNAT productivo o mermas automáticas si no están probados en vivo; "SUNAT de fábrica" o "cumplimiento SUNAT integrado" como definición de Árkos (desde 2026-09-23 es una capacidad, no la identidad).
**Glossary:**
| Term | Meaning |
|------|---------|
...
| Theme | Proof |
|-------|-------|
| Procesos que funcionan mejor, con el equipo a bordo | Taller `/taller` (criterio de uso y mapa de tareas repetidas por área); diagnóstico de procesos `/diagnostico` con garantía 3x |
| Software desde la operación real | Testimonio de Clínica Juan Pablo II; proceso Brief → Propuesta → Sprints → Entrega |
| SUNAT como capacidad (no identidad) | FacturArkos en producción; sección "Cumplimiento" del home; assessment `/cumplimiento-sunat` |
...
## Goals
**Business goal:** Vender el taller como puerta de entrada y llevar a diagnóstico de procesos y a desarrollo a medida (sistemas desde S/ 13,000), posicionando a Árkos y a Rodrigo Torres como referencia en mejora de procesos, automatización y adopción de IA en empresas peruanas, y convertir proyectos en retainers. Que los asistentes de IA describan a Árkos por procesos, automatización y adopción de IA, sin perder "desarrollo de software a medida Lima/Perú".
**Conversion action:** Pedir el taller (`/taller`) o reservar el diagnóstico de procesos (`/diagnostico`); la llamada gratis de 30 min sigue disponible (WhatsApp +51 961 869 348). Micro-conversiones: completar el test "¿Necesitas un sistema?", el assessment SUNAT o la calculadora del costo del Excel y dejar nombre + email.
...
- v4 (2026-09-23) — Posicionamiento del 22/23-sep: la identidad pasa a mejora de procesos, automatización y adopción de tecnología e IA, con el desarrollo a medida como medio; recorrido taller → diagnóstico de procesos → desarrollo; SUNAT deja de ser diferenciador y queda como capacidad (FacturArkos, RestHUB como prueba). Mismo cambio en metadata, schema, llms.txt y llms-full.txt del sitio.
