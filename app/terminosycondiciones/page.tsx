...
export default function TermsAndConditionsPage() {
  return (
    <main className="relative min-h-screen pt-32 md:pt-40 pb-24 bg-background">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div>
          ...
          <h2 className="text-2xl font-semibold mb-4">5. Responsabilidad Limitada</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mb-4">7. Modificación de los Términos y Condiciones</h2>
          <p>
