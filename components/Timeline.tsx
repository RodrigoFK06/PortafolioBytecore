    ...
    <div className="relative pl-16 md:pl-[25%]" ref={ref}>
      ...
      >
        ...
        >
          ...
          <div className="relative bg-black/[0.04] dark:bg-white/[0.03] backdrop-blur-[12px] p-6 rounded-xl border border-black/10 dark:border-white/10 transition-all duration-500 overflow-hidden">
