        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 relative">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center space-y-8 md:space-y-12 lg:mt-32">
            ...
            <RevealBlock direction="right">
              {/* Glassmorphism Card */}
              <div className="p-8 rounded-2xl border border-black/10 dark:border-white/10 bg-black/[0.04] dark:bg-white/[0.04] backdrop-blur-[24px] shadow-[0_8px_32px_rgba(0,0,0,0.05)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] relative transition-colors">
