...
export function ContactClient() {
  return (
    <motion.div
      ...
      className="group bg-black/[0.04] dark:bg-white/[0.01] backdrop-blur-[12px] p-8 md:p-10 rounded-2xl border border-black/10 dark:border-white/5 transition-all duration-500 shadow-[0_4px_24px_rgba(0,0,0,0.02)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.2)] overflow-hidden h-full flex flex-col relative z-10"
    >
      ...
      <h3 className="text-2xl font-bold mb-2 text-foreground relative z-10">Cuéntanos sobre tu proyecto</h3>
      <p className="text-foreground/70 text-sm mb-8 relative z-10">
